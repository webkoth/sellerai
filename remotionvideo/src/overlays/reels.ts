...
export const REELS: Reel[] = [
  {
    ...
    items: [
      ...
      { role: "KEY", text: "Не в ванной. Не на подоконнике.", durationSec: 3.0 },
  ...
  },
  {
    ...
    items: [
      ...
      { role: "KEY", text: "Дозиметр покажет *фон комнаты*", durationSec: 3.2, transition: "slide" },
      { role: "KEY", text: "Не пили и не шлифуй дома", durationSec: 3.0 },
  ...
  },
  {
    ...
    items: [
      ...
      { role: "KEY", text: "Камень воли, пути и космической памяти", durationSec: 3.5, transition: "slide" },
      { role: "KEY", text: "Не чудо. *Напоминание*.", durationSec: 3.0 },
  ...
  },
  {
    ...
    items: [
      ...
      { role: "KEY", text: "Природный рельеф — *не подделать*", durationSec: 3.2, transition: "slide" },
      { role: "KEY", text: "Существует в *одном* экземпляре", durationSec: 3.2 },
  ...
  },
  {
    ...
    items: [
      ...
      { role: "KEY", text: "Металл, что *не из земли* — а с неба", durationSec: 3.5 },
      ...
      { role: "KEY", text: "Небо и земля в *одном* предмете", durationSec: 3.2 },
