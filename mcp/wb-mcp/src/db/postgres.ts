...
/**
 * Log operation to operations_log
 */
export async function logOperation(params: {
  ...
  await query(
    `INSERT INTO operations_log
     (marketplace, domain, action, tool_name, params, result, success, confirmed_by, preview_shown)
    ...
    [
      ...
      params.previewShown ? JSON.stringify(params.previewShown) : null,
    ]
  );
}
